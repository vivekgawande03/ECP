...
export const packages: Package[] = [
  ...
  },
  {
    ...
    features: ['Integrated trailer control', 'Heavy-duty suspension', 'Trailer backup guide'],
    priceModifier: 1800,
    disabledTrims: [],
  },
];
...
export function getExteriorOptionById(id: string): ExteriorOption | undefined {
  return exteriorOptions.find((o) => o.id === id);
}

export function getInteriorOptionById(id: string): InteriorOption | undefined {
  return interiorOptions.find((o) => o.id === id);
}
